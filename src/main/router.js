...
if (process.env.VUE_APP_FEATURE_PAGE_METHODS) {
  routes.push({
    path: '/methods',
    components: {
...
if (process.env.VUE_APP_FEATURE_PAGE_STATUSES) {
  routes.push({
    path: '/statuses',
    components: {
...
if (process.env.VUE_APP_FEATURE_PAGE_HEADERS) {
  routes.push({
    path: '/headers',
    components: {
...
if (process.env.VUE_APP_FEATURE_PAGE_STATS) {
  routes.push({
    path: '/statistics',
    components: {
