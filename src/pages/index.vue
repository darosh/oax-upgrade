      ...
      v-container.pa-0-sm(fluid grid-list-xl v-if="SPEC.info._.description || SPEC.info.title")
        v-layout(column)
          v-flex
            ...
            v-expansion-panel.mb-2.expansion-panel-round(:value="[exp1]" v-if="SPEC.info._.description" expand :class="{'expansion-panel--disabled': !SPEC.info._.description}")
              v-expansion-panel-content.bg.relative(ripple)
