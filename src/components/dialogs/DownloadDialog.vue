    ...
    v-card
      v-layout(column style="height: 100vh")
        v-toolbar.transparent.elevation-0
          ...
          v-spacer
          v-select(style="max-width: 78px; min-width: 78px" hide-details single-line menu-props="bottom" v-model="json", :items="[{text: 'JSON', value: true},{text: 'YAML', value: false}]")
          v-select.ml-3(style="max-width: 86px; min-width: 86px" hide-details single-line menu-props="bottom" v-model="bundled", :items="[{text: 'Bundled', value: true},{text: 'Original', value: false}]")
        div
          v-divider
